	...
	function niceOutput($all=0){
		...
		while (($buffer = fgets($handle, 4096)) !== false) {
			...
			if ($fields[0] == "F" and ($all===0 or $all===2)) {
				echo "<li class='col-lg-3'><a href='$fields[2]' target='_blank' class='readinglist'>$fields[1]</a>   <span class='delete'><a href='index.php?delete_id=$i'  class='btn btn-default btn-xs btn-inline'><span class='glyphicon glyphicon-remove showTip' id='removeItem' data-toggle='tooltip' title='remove'></span></a><a href='#' class='btn btn-xs btn-default btn-inline' data-toggle='modal' data-target='#renameModal' data-id='$i'><span class='glyphicon glyphicon-registration-mark showTip' id='renameItem' data-toggle='tooltip' title='rename'></a></span></li>";
			}
